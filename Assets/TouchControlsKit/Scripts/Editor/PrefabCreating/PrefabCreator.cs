    ...
    public sealed class PrefabCreator : Editor
    {
        ...
        private static void CreateEventSystem()
        {
            if( !FindObjectOfType<EventSystem>() )
            {
              ...
              esGo.GetComponent<TouchInputModule>().allowActivationOnStandalone = true;
            }
        }
        ...
        private static void CreateButton()
        {
            ...
            btnTemp.touchzoneImage = button.GetComponent<Image>();
            btnTemp.touchzoneRect = button.GetComponent<RectTransform>();
            ...
            btnTemp.touchzoneRect.sizeDelta = Vector2.one * 45f;            
            button.transform.localScale = Vector3.one;
            btnTemp.touchzoneRect.anchoredPosition = RandomPos;
        }
        ...
        private static void CreateJoystick()
        {
            ...
            joyTemp.touchzoneImage = joystickMain.GetComponent<Image>();
            joyTemp.touchzoneRect = joystickMain.GetComponent<RectTransform>();
            joyTemp.touchzoneImage.sprite = AssetDatabase.LoadAssetAtPath<Sprite>( "Assets/" + nameAbbrev + "/Sprites/Touchzone.png" );
            ...
            joyTemp.touchzoneRect.sizeDelta = new Vector2( 180f, 160f );
            
            joyTemp.MyName = joystickMain.name;

            joystickMain.transform.localScale = Vector3.one;
            joyTemp.touchzoneRect.anchoredPosition = RandomPos;
        }
        ...
        private static void CreateTouchpad()
        {
            ...
            tpTemp.touchzoneImage = touchpad.GetComponent<Image>();
            tpTemp.touchzoneRect = touchpad.GetComponent<RectTransform>();
            tpTemp.touchzoneImage.sprite = AssetDatabase.LoadAssetAtPath<Sprite>( "Assets/" + nameAbbrev + "/Sprites/Touchzone.png" );
            tpTemp.MyName = touchpad.name;
            tpTemp.touchzoneRect.sizeDelta = new Vector2( 270f, 170f );

            touchpad.transform.localScale = Vector3.one;
            tpTemp.touchzoneRect.anchoredPosition = RandomPos;
        }
        ...
        private static void CreateDPad()
        {
            ...
            dpadTemp.touchzoneImage = dpadMain.GetComponent<Image>();
            dpadTemp.touchzoneRect = dpadMain.GetComponent<RectTransform>();
            ...
            dpadTemp.touchzoneRect.sizeDelta = Vector2.one * 175f;
            dpadTemp.touchzoneImage.sprite = AssetDatabase.LoadAssetAtPath<Sprite>( "Assets/" + nameAbbrev + "/Sprites/Touchzone.png" );

            SetupController<TCKDPadArrow>( ref dpadArrowUP, dpadMain.transform, "ArrowUP", true, TCKDPadArrow.ArrowTypes.UP );
            SetupController<TCKDPadArrow>( ref dpadArrowDOWN, dpadMain.transform, "ArrowDOWN", true, TCKDPadArrow.ArrowTypes.DOWN );
            SetupController<TCKDPadArrow>( ref dpadArrowLEFT, dpadMain.transform, "ArrowLEFT", true, TCKDPadArrow.ArrowTypes.LEFT );
            SetupController<TCKDPadArrow>( ref dpadArrowRIGHT, dpadMain.transform, "ArrowRIGHT", true, TCKDPadArrow.ArrowTypes.RIGHT );
            ...
            dpadTemp.touchzoneRect.anchoredPosition = RandomPos;
        }
        ...
        private static void CreateSteeringWheel()
        {
            ...
            swTemp.touchzoneImage = steeringWheel.GetComponent<Image>();
            swTemp.touchzoneRect = steeringWheel.GetComponent<RectTransform>();
            swTemp.touchzoneImage.sprite = AssetDatabase.LoadAssetAtPath<Sprite>( "Assets/" + nameAbbrev + "/Sprites/SteeringWheel.png" );
            swTemp.MyName = steeringWheel.name;
            swTemp.touchzoneRect.sizeDelta = Vector2.one * 125f;

            steeringWheel.transform.localScale = Vector3.one;
            swTemp.touchzoneRect.anchoredPosition = RandomPos;
        }
        ...
        private static void SetupController<TComp>(
            ...
            TCKDPadArrow.ArrowTypes myType = TCKDPadArrow.ArrowTypes.none ) where TComp : MonoBehaviour
        {
            ...
            if( myType != TCKDPadArrow.ArrowTypes.none )
            {
                myGO.GetComponent<TCKDPadArrow>().ArrowType = myType;
                CalcDPadSizeAndPos( dpadMain.GetComponent<RectTransform>(), myGO.GetComponent<RectTransform>(), myType );
            }
        }

        // CalcDPadSizeAndPos
        private static void CalcDPadSizeAndPos( RectTransform mainRect, RectTransform childRect, TCKDPadArrow.ArrowTypes myType )
        {
            childRect.sizeDelta = new Vector2( mainRect.sizeDelta.x / 3.4f, mainRect.sizeDelta.y / 3.4f );

            switch( myType )
            {
                case TCKDPadArrow.ArrowTypes.UP:
                ...
                case TCKDPadArrow.ArrowTypes.DOWN:
                    childRect.anchoredPosition = new Vector2( 0f, childRect.sizeDelta.y / 2f );                    
                ...
                case TCKDPadArrow.ArrowTypes.LEFT:
                ...
                case TCKDPadArrow.ArrowTypes.RIGHT:
                    childRect.anchoredPosition = new Vector2( -childRect.sizeDelta.x / 2f, 0f );                    
